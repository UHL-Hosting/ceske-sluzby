...
function ceske_sluzby_xml_kategorie_pridat_pole() {
  ...
  if ( $xml_feed_heureka == "yes" ) { ?>
    ...
    <div class="form-field">
      ...
      <p>
        Zatím je nutné doplnit příslušnou kategorii z Heureky ručně (aktuální přehled naleznete <a href="https://www.<?php echo HEUREKA_URL; ?>/direct/xml-export/shops/heureka-sekce.xml" target="_blank" rel="noopener noreferrer" aria-label="<?php echo esc_attr__( 'v přehledu kategorií Heureky (otevře se v novém okně)', 'ceske-sluzby' ); ?>">v přehledu kategorií Heureky</a>).<br />
  ...
  if ( $xml_feed_zbozi == "yes" ) { ?>
    ...
    <div class="form-field">
      ...
      <p>
        Zatím je nutné doplnit příslušnou kategorii ze Zbozi.cz ručně (aktuální přehled naleznete <a href="https://www.zbozi.cz/static/categories.csv" target="_blank" rel="noopener noreferrer" aria-label="<?php echo esc_attr__( 'v přehledu kategorií Zboží.cz (otevře se v novém okně)', 'ceske-sluzby' ); ?>">v přehledu kategorií Zboží.cz</a>).<br />
    ...
    <?php if ( empty( $global_data['nazev_produktu'] ) || strpos( $global_data['nazev_produktu'], '{KATEGORIE}' ) !== false ) { ?>
      <div class="form-field">
        ...
        <p>
          Pomocí placeholderů můžete doplnit obecný název pro všechny produkty z příslušné kategorie Zboží.cz (aktuální přehled naleznete <a href="https://napoveda.seznam.cz/cz/zbozi/specifikace-xml-pro-obchody/pravidla-pojmenovani-nabidek/" target="_blank" rel="noopener noreferrer" aria-label="<?php echo esc_attr__( 'v nápovědě Zboží.cz (otevře se v novém okně)', 'ceske-sluzby' ); ?>">v nápovědě Zboží.cz</a>).<br />
  ...
  if ( $xml_feed_glami == "yes" ) { ?>
    ...
    <div class="form-field">
      ...
      <p>
        Zatím je nutné doplnit příslušnou kategorii z Glami ručně (aktuální přehled naleznete <a href="https://www.<?php echo GLAMI_URL; ?>/category-xml/" target="_blank" rel="noopener noreferrer" aria-label="<?php echo esc_attr__( 'v přehledu kategorií Glami (otevře se v novém okně)', 'ceske-sluzby' ); ?>">v přehledu kategorií Glami</a>).<br />
  ...
  if ( $xml_feed_heureka == "yes" ) { ?>
    ...
    <tr class="form-field">
      ...
      <td> 
        ...
        <p class="description">
          Zatím je nutné doplnit příslušnou kategorii z Heureky ručně (aktuální přehled naleznete <a href="http://www.<?php echo HEUREKA_URL; ?>/direct/xml-export/shops/heureka-sekce.xml" target="_blank" rel="noopener noreferrer" aria-label="<?php echo esc_attr__( 'v přehledu kategorií Heureky (otevře se v novém okně)', 'ceske-sluzby' ); ?>">v přehledu kategorií Heureky</a>).<br />
          Příklad: <strong>Elektronika | Počítače a kancelář | Software | Antiviry</strong><br />
          Poznámka: Z <code>CATEGORY_FULLNAME</code> je třeba vynechat část <code><?php echo ucfirst( HEUREKA_URL ); ?> | </code>.
        </p>
      </td>
  ...
  if ( $xml_feed_zbozi == "yes" ) { ?>
    ...
    <tr class="form-field">
      ...
      <td> 
        ...
        <p class="description">
          Zatím je nutné doplnit příslušnou kategorii ze Zbozi.cz ručně (aktuální přehled naleznete <a href="http://www.zbozi.cz/static/categories.csv" target="_blank" rel="noopener noreferrer" aria-label="<?php echo esc_attr__( 'v přehledu kategorií Zboží.cz (otevře se v novém okně)', 'ceske-sluzby' ); ?>">v přehledu kategorií Zboží.cz</a>).<br />
          Příklad: <strong>Počítače | Software | Grafický a video software</strong><br />
        </p>
      </td>
    </tr>
      ...
      <tr class="form-field">
        ...
        <td> 
          <input name="ceske-sluzby-xml-zbozi-productname" id="ceske-sluzby-xml-zbozi-productname" type="text" value="<?php echo esc_attr( $zbozi_productname ); ?>" placeholder="PRODUCTNAME" />
            <p class="description">
              Pomocí placeholderů můžete doplnit obecný název pro všechny produkty z příslušné kategorie Zboží.cz (aktuální přehled naleznete <a href="http://napoveda.seznam.cz/cz/zbozi/specifikace-xml-pro-obchody/pravidla-pojmenovani-nabidek/" target="_blank" rel="noopener noreferrer" aria-label="<?php echo esc_attr__( 'v nápovědě Zboží.cz (otevře se v novém okně)', 'ceske-sluzby' ); ?>">v nápovědě Zboží.cz</a>).<br />
              Příklad pro konrétní kategorii: <strong>Výrobce | Druh | Barva</strong><br />
              Pokud používáte nastavení výrobce, druh máte jako název produktu a barvu zase uloženou jako vlastnost v podobě taxonomie, tak můžete zadat: <code>{MANUFACTURER} {NAZEV} {pa_barva}</code>
            </p>
        </td>
  ...
  if ( $xml_feed_glami == "yes" ) { ?>
    ...
    <tr class="form-field">
      ...
      <td> 
        ...
        <p class="description">
          Zatím je nutné doplnit příslušnou kategorii z Glami ručně (aktuální přehled naleznete <a href="http://www.<?php echo GLAMI_URL; ?>/category-xml/" target="_blank" rel="noopener noreferrer" aria-label="<?php echo esc_attr__( 'v přehledu kategorií Glami (otevře se v novém okně)', 'ceske-sluzby' ); ?>">v přehledu kategorií Glami</a>).<br />
          Příklad: <strong>Dámské oblečení a obuv | Dámské boty | Dámské outdoorové boty</strong><br />
          Poznámka: Z <code>CATEGORY_FULLNAME</code> je třeba vynechat část <code><?php echo ucfirst( GLAMI_URL ); ?> | </code>.
        </p>
      </td>
